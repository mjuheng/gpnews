	...
	<view>
		<view class="content">
			<view class="row">
				...
				<view class="input">
					<input @focus="focus" @blur="onBlur" placeholder="请输入收件人姓名" type="text" v-model="name" />
				</view>
			</view>
			<view class="row">
				<view class="nominal">
				...
				<view class="input">
					<input  maxlength="11" placeholder="请输入收件人电话号码" type="number" v-model="tel" />
				</view>
			</view>
			<view class="row">
				<view class="nominal">
			...
			<view class="row">
				...
				<view class="input">
					<textarea @blur="onBlur" v-model="detailed" auto-height="true" placeholder="输入详细地址"></textarea>
				</view>
			</view>
			<view class="row">
				<view class="nominal">
	...
	export default {
		...
		methods: {
			...
			save() {
				...
				let jsonAddress = JSON.stringify(this.region);
